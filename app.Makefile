...
$(shell echo '$(APP_PARAMETERS)' \
    | docker run -i --entrypoint=/bin/print_config.py --rm $(APP_DEPLOYER_IMAGE) --mode stdin --param '{"x-google-marketplace": {"type": "NAME"}}')
endef
...
$(shell echo '$(APP_PARAMETERS)' \
    | docker run -i --entrypoint=/bin/print_config.py --rm $(APP_DEPLOYER_IMAGE) --mode stdin --param '{"x-google-marketplace": {"type": "NAMESPACE"}}')
endef
